...
- Added a 'Test API Connection' button to the UI for verifying API connectivity.
...
- Added a test to verify the 'Test API Connection' button and health check functionality.
